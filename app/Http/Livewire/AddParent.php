...
//                    $parentAttachment=new  ParentAttachment();
//                    $parentAttachment->file_name=$photo->getClientOriginalName();
//                    $parentAttachment->parent_id=$My_Parent->id;
//                    $parentAttachment->save();
                }
            }
    ...
    public function firstStepSubmit_edit()
    {
        $this->validate([
            ...
            'Job_Father' => 'required',
            'Job_Father_en' => 'required',
            'National_ID_Father' => 'required|string|min:10|max:10|unique:my__parents,National_ID_Father,' . $this->Parent_id,
    ...
    public function secondStepSubmit_edit()
    {
        $this->validate([
            'Name_Mother' => 'required',
            'Name_Mother_en' => 'required',
            'National_ID_Mother' => 'required|string|min:10|max:10|unique:my__parents,National_ID_Mother,' . $this->Parent_id,
