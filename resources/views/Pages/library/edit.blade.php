                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="Grade_id">
                                                ...
                                                @foreach($grades as $grade)
                                                    <option
                                                        value="{{ $grade->id }}" {{$book->Grade_id == $grade->id ?'selected':''}}>
                                                        {{ $grade->Name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="Classroom_id">
                                                <option
                                                    value="{{$book->Classroom_id}}">{{$book->classroom->Class_Name}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="section_id">
                                                <option
                                                    value="{{$book->section_id}}">{{$book->section->Section_Name}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
