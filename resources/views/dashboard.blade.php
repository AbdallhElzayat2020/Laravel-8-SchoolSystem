                                    ...
                                    <div class="tab-pane fade active show" id="students" role="tabpanel"
                                        ...
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center"
                                                ...
                                                <tbody>
                                                    @forelse(\App\Models\Students\Student::with(['gender','grade','classroom','section'])->latest()->take(5)->get() as $key=> $student)
                                                        <tr>
                                                            <td>{{ $key + 1 }}</td>
                                                            <td>{{ $student->name }}</td>
                                                            <td>{{ $student->email }}</td>
                                    ...
                                    <div class="tab-pane fade" id="teachers" role="tabpanel"
                                        ...
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center"
                                                ...
                                                @forelse(\App\Models\Teacher\Teacher::latest()->take(5)->get() as $teacher)
                                                    <tbody>
                                                        <tr>
                                    ...
                                    <div class="tab-pane fade" id="fee_invoices" role="tabpanel"
                                        ...
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center"
                                                ...
                                                <tbody>
                                                    @forelse(\App\Models\Fee_invoive\Fee_invoive::latest()->take(10)->get() as $section)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
